...
?>
  ...
  <h1 class="uppercase page-title" style="margin-left: 35px;margin-top:10px;"><?php echo ucwords($cat_name); ?></h1>
<?php 
	if ($query->have_posts()) {
 ...
 ?>
			<div class="col span_12_of_12 blog-container">  
				...
				<div class="col span_9_of_12 blog-text">
					<h1 style="font-size:1.5vw;margin-top:0px;" ><?php the_title(); ?></h1>
<?php 
...
?>
					<p><?php echo mb_strimwidth(wp_strip_all_tags( $content ), 0, 400, "..."); ?></p>
